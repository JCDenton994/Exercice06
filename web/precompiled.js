...
$$.Closure$create_contact = [T, {"": "Closure;call$1,$name"}];

$$.Closure$modify_contact = [T, {"": "Closure;call$1,$name"}];

$$.Closure$delete_contact = [T, {"": "Closure;call$1,$name"}];

$$.Closure$next_contact = [T, {"": "Closure;call$1,$name"}];

$$.Closure$previous_contact = [T, {"": "Closure;call$1,$name"}];
...
InputElement: {"": "HtmlElement;name=,value=", $isElement: true, $asElement: null, $isNode: true, $asNode: null},
...
["exercice6", "exercice6.dart", , T, {
init: function() {
  var contact1, contact2, contact3;
  contact1 = new T.Contact(null, null, null, null, null);
  contact1.idcontact = 1;
  contact1.name = "\u00c9chantillon";
  contact1.pname = "Jean";
  contact1.email = "jean.echantillon@gmail.com";
  contact1.phone = "555-5555";
  $.get$contacts().push(contact1);
  contact2 = new T.Contact(null, null, null, null, null);
  contact2.idcontact = 2;
  contact2.name = "Doe";
  contact2.pname = "John";
  contact2.email = "john.doe@gmail.com";
  contact2.phone = "555-5556";
  $.get$contacts().push(contact2);
  contact3 = new T.Contact(null, null, null, null, null);
  ...
  $.get$contacts().push(contact3);
},

main: function() {
  var btn_create, t1, t2, t3, btn_modify, btn_delete, btn_next, btn_previous;
  T.init();
  T.display();
  btn_create = document.querySelector("#btn_create");
  btn_create.get$onClick;
  t1 = C.EventStreamProvider_click._eventType;
  t2 = new W._ElementEventStreamImpl(btn_create, t1, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, T.create_contact$closure, t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  btn_modify = document.querySelector("#btn_modify");
  btn_modify.get$onClick;
  t3 = new W._ElementEventStreamImpl(btn_modify, t1, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, T.modify_contact$closure, t3._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t2._tryResume$0();
  btn_delete = document.querySelector("#btn_delete");
  btn_delete.get$onClick;
  t2 = new W._ElementEventStreamImpl(btn_delete, t1, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, T.delete_contact$closure, t2._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t3._tryResume$0();
  btn_next = document.querySelector("#btn_next");
  btn_next.get$onClick;
  t3 = new W._ElementEventStreamImpl(btn_next, t1, false);
  H.setRuntimeTypeInfo(t3, [null]);
  t2 = new W._EventStreamSubscription(0, t3._target, t3._eventType, T.next_contact$closure, t3._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t3, "_EventStream", 0)]);
  t2._tryResume$0();
  btn_previous = document.querySelector("#btn_previous");
  btn_previous.get$onClick;
  t1 = new W._ElementEventStreamImpl(btn_previous, t1, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, T.previous_contact$closure, t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
},

display: function() {
  var t1, list, contact, alink;
  for (t1 = $.get$contacts(), t1 = new H.ListIterator(t1, t1.length, 0, null), list = "<table align=center border=1><tr><th>IDcontact</th><th>Name</th><th>First Name</th><th>Email</th><th>Phone</th></tr>"; t1.moveNext$0();) {
    contact = t1._current;
    alink = "    <tr><td>" + H.S(contact.get$idcontact()) + "</td>\r\n        <td>" + J.get$name$x(contact) + "</td>\r\n        <td>" + contact.get$pname() + "</td>\r\n        <td>" + contact.get$email() + "</td>\r\n        <td>" + contact.get$phone() + "</td></tr>";
    list = list + " " + alink;
  }
...
init.globalFunctions.create_contact$closure = T.create_contact$closure = new T.Closure$create_contact(T.create_contact, "create_contact$closure");
init.globalFunctions.modify_contact$closure = T.modify_contact$closure = new T.Closure$modify_contact(T.modify_contact, "modify_contact$closure");
init.globalFunctions.delete_contact$closure = T.delete_contact$closure = new T.Closure$delete_contact(T.delete_contact, "delete_contact$closure");
init.globalFunctions.next_contact$closure = T.next_contact$closure = new T.Closure$next_contact(T.next_contact, "next_contact$closure");
init.globalFunctions.previous_contact$closure = T.previous_contact$closure = new T.Closure$previous_contact(T.previous_contact, "previous_contact$closure");
...
Isolate.$lazy($, "contacts", "contacts", "get$contacts", function() {
  return P.List_List(null, null);
});
// Native classes
H.defineNativeMethods("DOMImplementation|MediaError|MediaKeyError|Navigator|PositionError|SQLError|SVGAnimatedNumberList", J.Interceptor);
...
function dart_precompiled($collectedClasses) {
  ...
  function Bound__run__ZoneTimer(_self, _liblib1$_target, _receiver, _liblib1$_name) {
    this._self = _self;
    this._liblib1$_target = _liblib1$_target;
    this._receiver = _receiver;
    this._liblib1$_name = _liblib1$_name;
  ...
  function Contact(idcontact, name, pname, email, phone) {
  ...
  Contact.prototype.get$idcontact = function() {
    return this.idcontact;
  };
  Contact.prototype.get$name = function(receiver) {
    return this.name;
  };
  Contact.prototype.get$pname = function() {
    return this.pname;
  };
  Contact.prototype.get$email = function() {
    return this.email;
  };
  Contact.prototype.get$phone = function() {
    return this.phone;
  };
